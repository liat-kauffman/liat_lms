...
const features: featureProps[] = [
  {
    ...
    description: "Access a wide range of carefully created courses designed by industry experts.",
    icon:'📚'
  },
  {
    ...
    <>    
      <section className="relative py-20">
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <p className="max-w-175 text-muted-foreground md:text-xl">Discover a new way to learn with our modern, interactive learning management system.
